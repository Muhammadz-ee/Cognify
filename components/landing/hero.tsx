      ...
      <Container>
        <div className="flex flex-col items-center text-center z-10">
          ...
          <motion.div
            ...
            className="under-heading text-[#ad9ad6] font-bold mb-10 mx-auto text-center px-4 body-text"
          >
            Turn Long Podcasts into Smart Takeaways. Instantly.
            <br />
            <span className="under-heading text-white block mt-2">+ smart notes and study tools.</span>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative w-full -top-0 max-w-[1320px] mx-auto mb-12 z-10 px-4"
          >
            ...
            <div className="absolute inset-x-0 md:top-50 lg:top-110 flex justify-center z-0 pointer-events-none">
              <div className="flex gap-4 md:gap-6 lg:gap-10 items-center opacity-40 lg:opacity-60 transform -translate-y-6">
                ...
                <div className="hidden lg:block w-[620px]"></div>
            ...
            */}
            <div className="relative overflow-hidden shadow-2xl shadow-purple-900/30 h-[520px] md:h-[820px] lg:h-[1900px] w-full mx-auto">
              <video
              ...
              <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-20 w-full px-4 flex flex-col items-center gap-6">
                ...
                <div className="mt-12 relative z-10 max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-10">
                  ...
                  <p className="text-sm md:text-lg lg:text-xl font-extrabold italic text-white text-center md:text-left max-w-2xl leading-snug body-text">
