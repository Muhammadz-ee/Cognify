      ...
      <Container>
        <div className="flex flex-col items-center text-center z-10">
          ...
          <motion.div
            ...
            className="text-[18px] md:text-[24px] text-[#ad9ad6] font-bold mb-10 mx-auto text-center px-4"
          >
            Turn Long Podcasts into Smart Takeaways. Instantly.
            <br />
            <span className="text-white block mt-2 text-[15px] md:text-[18px]">
          ...
          <motion.div
            ...
            className="flex flex-row justify-center w-full gap-4 sm:gap-6 mb-20 z-30 px-2"
          >
            <Button
              size="lg"
          ...
          >
            ...
            <div className="absolute inset-x-0 md:top-40 lg:top-70 flex justify-center z-0 pointer-events-none">
              <div className="flex gap-4 md:gap-8 lg:gap-12 items-center opacity-40 lg:opacity-60 transform -translate-y-6">
                <div className="flex flex-col gap-3">
                  <Image
                    ...
                    width={220}
                    height={220}
                    className="rounded-3xl shadow-xl w-24 h-24 md:w-32 md:h-32 lg:w-[220px] lg:h-[220px] object-cover"
                  />
                  <div className="text-left hidden lg:block max-w-[220px]">
                    <span className="text-[15px] font-bold text-white block truncate">The Mel Robbins Podcast</span>
                    <span className="text-[13px] text-gray-400 block mt-1">Mel Robbins</span>
                  </div>
                </div>
                <div className="flex flex-col gap-3">
                  <Image
                  ...
                  />
                  <div className="text-left hidden lg:block max-w-[220px]">
                    <span className="text-[15px] font-bold text-white block truncate">Huberman Lab</span>
                    <span className="text-[13px] text-gray-400 block mt-1">Andrew Huberman</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  <Image
                    ...
                    width={220}
                    height={220}
                    className="rounded-3xl shadow-2xl w-24 h-24 md:w-32 md:h-32 lg:w-[220px] lg:h-[220px] object-cover"
                  />
                  <div className="text-left hidden lg:block max-w-[220px]">
                    <span className="text-[15px] font-bold text-white block truncate">The Diary Of A CEO</span>
                    <span className="text-[13px] text-gray-400 block mt-1">Steven Bartlett</span>
                  </div>
                </div>
                <div className="flex flex-col gap-3">
                  <Image
                  ...
                  />
                  <div className="text-left hidden lg:block max-w-[220px]">
                    <span className="text-[15px] font-bold text-white block truncate">Lex Fridman Podcast</span>
                    <span className="text-[13px] text-gray-400 block mt-1">Lex Fridman</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            */}
            <div className="relative overflow-hidden shadow-2xl shadow-purple-900/30 h-[750px] md:h-[1600px] w-full md:w-[1000px]">
              <video
              ...
              <div className="absolute bottom-32 left-1/2 transform -translate-x-1/2 z-20 w-full px-4 flex flex-col items-center gap-6">
                ...
                <div className="mt-10 relative z-10 max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-10">
                  <div className="flex flex-col items-center">
                    <div className="inline-flex bg-white rounded-full p-3 pr-8 items-center gap-4 shadow-2xl">
                      <div className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden relative border-2 border-purple-500/60">
                        <Image
